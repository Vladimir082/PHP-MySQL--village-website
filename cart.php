			...
			<div id="content_area">
				...
				<div id="shopping_cart">
					...
					?>
						...
						<?php total_items();?> Total Price:
						<?php total_price(); ?> <a href="index.php" style="color:yellow">Back to Shop</a>
				...
				<div id="products_box">
					...
					<form action="" method="post" enctype="multipart/form-data">
						<table align="center" width="700" bgcolor="#809966">
						...
						if(isset($_POST['update_cart'])){
							...
							<tr align="center">
								...
								<td><input type="submit" name="continue" value="Continue Shopping"/>
								</td>
