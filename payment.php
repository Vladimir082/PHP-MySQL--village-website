...
<center ><form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
  ...
  <input type="hidden" name="business" value="village_products@gmail.com">
...
<!--These will be to use to upload online to test if is working
<input type="hidden" name="return" value="http://www.your web hosting/village_ecommerce/paypal_success.php"/>
<input type="hidden" name="cancel_return" value="http://www.your web hosting/village_ecommerce/paypal_cancel.php"/>
-->
